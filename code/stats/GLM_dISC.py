...
parser = argparse.ArgumentParser(
    description="GLM between dISC time series and dISC behavioral signal")
...
for di in range(1, num_m+1):
    ...
    if EV_name in locals():
        ...
        scipy.io.savemat(os.path.join(result_path,'dISC_'+region_level_label[region_level]+'_DS'+str(format(di, '02'))+'.mat'), 
