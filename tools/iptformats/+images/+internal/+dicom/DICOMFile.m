classdef DICOMFile < handle
    ...
    methods
        function obj = DICOMFile(filename)
            ...
            useVRHeuristic = true;
            readPixelData = false;
            obj.RawAttrs = builtin('_dicomparse',fileDetails.name, ...
                fileDetails.bytes, ...
                getMachineEndian(), ...
                readPixelData, ...
                obj.Dictionary, ...
...
function set.PixelData(obj, value)
    ...
    methods (Access = private)
        ...
        function [vr, name] = findVRFromTag(obj, group, element)
            ...
            attr = builtin('_dicomlookup_helper',group, element, obj.Dictionary);
...
function addRawAttribute(obj, group, element, value)
            ...
            dictionaryAttr = builtin('_dicomlookup_helper',group, element, obj.Dictionary);
