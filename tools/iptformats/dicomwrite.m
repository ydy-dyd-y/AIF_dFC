...
%   are allowed:
%
%     'Endian'                The byte-ordering for the file: 'ieee-be' or
%                             'ieee-le' (default).  
%
...
%   VR.  Specifying an Endian value of 'ieee-be' and a VR value of 'implicit'
%   is not allowed.
%
%
...
%   different image pixel data. If the image data is empty, DICOMWRITE does
%   not write image related metadata attributes to the new DICOM file. 
%      
%
%
%   WARNING
