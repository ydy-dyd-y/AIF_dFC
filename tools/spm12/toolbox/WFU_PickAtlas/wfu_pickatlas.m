...
% Last Modified by GUIDE v2.5 04-Jun-2004 10:05:06
...
if nargin <=1  % LAUNCH GUI
    ...
    % Set PickAtlas title
    set(fig, 'Name', 'WFU PickAtlas Tool Version 2.0');
...
% --------------------------------------------------------------------
    ...
    handles.AdvancedControls = ...
        [handles.txtWorkF handles.cmdCommit handles.cmdDelete handles.chkSelectAll ...
         ...
         handles.txtFinal, handles.cmdUnion, handles.cmdIntersection];
...
%    end
    ...
    % create a image object to display the mask
...
% --------------------------------------------------------------------
    ...
    a.Operator = Operator;% union or intersection
...
% --------------------------------------------------------------------
    ...
    if(handles.selectedpoint.z == handles.slice)
        ...
        if (handles.FlipDisplay)
            posx=93- handles.selectedpoint.x;
        else
