...
Downloading the Software
     The wfu_pickatlas toolbox and user manual can be obtained from www.rad.wfubmc.edu/fmri 

Program Installation
     Untar the tar file into the toolbox directory of your SPM installation:
	tar -xvf wfu_pickatlas.tar  
This will create a subdirectory called wfu_pickatlas in your SPM toolbox directory.  You will also need to set your matlab path to access the wfu_pickatlas directory:
	path(SPMpath/toolbox/wfu_pickatlas,path); 
The wfu_pickatlas toolbox path must be above the SPM path.  If the software is installed properly, you should be able to call up the GUI from the matlab command prompt with:     wfu_pickatlas;
