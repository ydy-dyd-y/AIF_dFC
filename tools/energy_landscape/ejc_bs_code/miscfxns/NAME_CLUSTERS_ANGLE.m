function [clusterNames,reorderClusters,clusterNamesSort,net7angle] = NAME_CLUSTERS_ANGLE(centroids, net)
...
elseif nparc == 100 || nparc == 116
    ...
    elseif net == 1
        ...
        network7labels=sch116_to_yeo_17;
    end
...
if net == 0
    ...
    numNets = 7;
elseif net == 1
    YeoNetNames = {'VISCent+', 'VISPer+', 'SOMa+','SOMb+', 'DATa+', 'DATb+', 'VATa+', 'VATb+', 'LIMb+', 'LIMa+', 'ContA+', 'ContB+', 'ContC+', 'DMNa+', 'DMNb+', 'DMNc+', 'TP+', 'VISCent-', 'VISPer-', 'SOMa-','SOMb-', 'DATa-', 'DATb-', 'VATa-', 'VATb-', 'LIMb-', 'LIMa-', 'ContA-', 'ContB-', 'ContC-', 'DMNa-', 'DMNb-', 'DMNc-', 'TP-'};
    numNets = 17;
end
